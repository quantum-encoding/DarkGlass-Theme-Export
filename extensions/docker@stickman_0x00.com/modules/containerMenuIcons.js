	...
	class Container_Menu extends ContainerMenu.Container_Menu {
		...
		add_compose() {
			...
			switch (this._container.state) {
				case "running":
					this.new_action_button("object-rotate-left", () => { // Restart
						DockerAPI.run_command(DockerAPI.docker_commands.compose_restart, this._container);
					}, DockerAPI.docker_commands.compose_restart.label);

					this.new_action_button("media-playback-stop", () => { // Stop
