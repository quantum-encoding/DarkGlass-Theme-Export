	...
	class Container_Menu extends ContainerMenu.Container_Menu {
		...
		add_compose() {
			...
			switch (this._container.state) {
				case "running":
					// Restart
					this._compose_restart = new PopupMenu.PopupMenuItem(DockerAPI.docker_commands.compose_restart.label);
					this._compose_restart.connect('activate', () => DockerAPI.run_command(DockerAPI.docker_commands.compose_restart, this._container));
					this.menu.addMenuItem(this._compose_restart);
